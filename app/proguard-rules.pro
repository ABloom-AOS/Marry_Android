...
# ui 패키지 클래스 난독화 제외 설정
-keep class com.abloom.mery.presentation.ui.signup.AuthenticationArgs { *; }
-keep class com.abloom.mery.presentation.ui.webview.WebViewUrl { *; }
-keep class com.abloom.mery.presentation.ui.category.CategoryArgs { *; }
